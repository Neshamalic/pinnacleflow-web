...
const AnalyticsPanel = ({ currentLanguage, onExportAnalytics }) => {
  ...
  const handleApplyFilters = () => {
    // Aquí aplicarías el filtrado real en el consumo de datos
  ...
  const handleExport = () => {
    if (onExportAnalytics) {
      ...
      console.log('Export analytics with filters: ', {
        category: selectedCategory,
        packaging: selectedPackaging,
        period: selectedPeriod,
        coverage: selectedCoverage,
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <div className="text-sm text-blue-600">
              {currentLanguage === 'es' ? t.activeProducts : 'Active Products'}
            </div>
          </div>
          ...
          <div className="text-center p-4 bg-red-50 rounded-lg border border-red-200">
            ...
            <div className="text-sm text-red-600">
              {currentLanguage === 'es' ? t.criticalStock : 'Critical Stock'}
            </div>
          </div>
          ...
          <div className="text-center p-4 bg-amber-50 rounded-lg border border-amber-200">
            ...
            <div className="text-sm text-amber-600">
              {currentLanguage === 'es' ? t.airShipment : 'Air Shipment'}
            </div>
          </div>
          ...
          <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <div className="text-sm text-green-600">
              {currentLanguage === 'es' ? t.healthyStock : 'Healthy Stock'}
            </div>
          </div>
        </div>
      </div>
